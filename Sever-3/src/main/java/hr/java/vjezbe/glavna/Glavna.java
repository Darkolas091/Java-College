...
public class Glavna {
     ...
     * @param poljePredmeta Popis predmeta koji se polažu.
     * @param poljeStudenta Popis studenata.
    ...
    /**
     * Metoda za ispis svih predmeta radi provjere spremanja.
     * @param poljePredmeta
     */
     ...
     * @param unos Scanner s kojim se čitaju podatci.
     * @param poljeProfesora Popis dostupnih profesora za nositelja predmeta.
     * @return Novi objekt s podacima učitanih koristeći dani scanner.
     */
