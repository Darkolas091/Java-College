...
public class Glavna {
    ...
    public static void main(String[] args) {
        ...
        for (int aa = 0; aa < brojUstanova; aa++) {
            ...
            if (odabirUstanove == 1)/*naopako*/ {
                sveuciliste.dodajObrazovnuUstanovu(new VeleucilisteJave(nazivUstanove, predmetList, profesorList, studentList, ispitiList));
            }
            else if (odabirUstanove == 2)/*naopako*/
            {
                sveuciliste.dodajObrazovnuUstanovu(new FakultetRacunarstva(nazivUstanove, predmetList, profesorList, studentList, ispitiList));
            }
        ...
        for (Student student : studentList) {
            ...
            System.out.println("Konačna ocjena studija studenta: " + student.getIme() +
                    " " + student.getPrezime() + ":");
            if (odabirUstanove == 1) {
                System.out.println((sveuciliste.dohvatiObrazovnuUstanovu(1)).izracunajKonacnuOcjenuStudijaZaStudenta(ispitiList, ocjenaZavrsnogRadaStudenta,
                        ocjenaObraneZavrsnogRadaStudenta,student));
            }
            if (odabirUstanove == 2) {
                System.out.println(((sveuciliste.dohvatiObrazovnuUstanovu(0)).izracunajKonacnuOcjenuStudijaZaStudenta(ispitiList, ocjenaZavrsnogRadaStudenta,
                        ocjenaObraneZavrsnogRadaStudenta,student)));
            }
                ...
                if (odabirUstanove == 1) {
                    ...
                    System.out.println("Najbolji student 2022. godine je " +
                            sveuciliste.dohvatiObrazovnuUstanovu(1).odrediNajuspjesnijegStudentaNaGodini(godina).getIme() +
                            " " + sveuciliste.dohvatiObrazovnuUstanovu(1).odrediNajuspjesnijegStudentaNaGodini(godina).getPrezime() + " "
                            + sveuciliste.dohvatiObrazovnuUstanovu(1).odrediNajuspjesnijegStudentaNaGodini(godina).getJmbag());
                    //TODO
                    /*for (var p : sveuciliste.dohvatiObrazovnuUstanovu(1).getPredmeti()) {
                ...
                if (odabirUstanove == 2) {
                    System.out.println("Najbolji student 2022. godine je " +
                            sveuciliste.dohvatiObrazovnuUstanovu(0).odrediNajuspjesnijegStudentaNaGodini(godina).getIme() +
                            " " + sveuciliste.dohvatiObrazovnuUstanovu(0).odrediNajuspjesnijegStudentaNaGodini(godina).getPrezime() + " "
                            + sveuciliste.dohvatiObrazovnuUstanovu(0).odrediNajuspjesnijegStudentaNaGodini(godina).getJmbag());

                    System.out.println("Student koji je osvojio rektorovu nagradu je: " +
                            ((FakultetRacunarstva) sveuciliste.dohvatiObrazovnuUstanovu(0)).odrediStudentaZaRektorovuNagradu().getIme() +
                            " " + ((FakultetRacunarstva) sveuciliste.dohvatiObrazovnuUstanovu(0)).odrediStudentaZaRektorovuNagradu().getPrezime() + " "
                            + ((FakultetRacunarstva) sveuciliste.dohvatiObrazovnuUstanovu(0)).odrediStudentaZaRektorovuNagradu().getJmbag());

                    //TODO
                    /*for (var p : sveuciliste.dohvatiObrazovnuUstanovu(0).getPredmeti()) {
            ...
            var sortiraneUstanove = sveuciliste
                    ...
                    .stream()
                    .sorted((a, b) -> {
                        int nStudentComp = b.dobijSveStudente().size() - a.dobijSveStudente().size();
            ...
            for (var o : sortiraneUstanove) {
                System.out.printf("%s: %d%n", o.getNaziv(), o.dobijSveStudente().size());
            }
